        ...
        <div class="col-md-8 mb-20">
            <div class="card-box height-100-p pd-20" style="position: relative">
                ...
                <div class="d-block mb-3" style="max-width: 250px;">
                    <img src="{{ $product->product_image ? asset('images/products/' . $product->product_image) : '' }}" class="img-thumbnail" id="image-preview" style="display: {{ $product->product_image ? 'block' : 'none' }};">
                </div>
        ...
        <div class="col-md-4 mb-20">
            ...
            <div class="card-box min-height-200px pd-20 mb-20">
                <div class="form-group">
                    ...
                    <input type="text" name="price" class="form-control" placeholder="Eg: 1000.00" value="{{ $product->price }}">
                    <span class="text-danger error-text price_error"></span>
                </div>
                <div class="form-group">
                    <label for=""><b>Compare Price:</b><small>Optional</small></label>
                    <input type="text" name="compare_price" class="form-control" placeholder="Eg: 1500.00" value="{{ $product->compare_price }}">
