...
<div class="tab">
        <ul class="nav nav-tabs customtab" role="tablist">
            <li class="nav-item">
                <a wire:click.prevent='selectTab("generel_settings")' class="nav-link {{ $tab == 'general_settings' ? 'active' : '' }}" data-toggle="tab" href="#general_settings" role="tab" aria-selected="true">General settings</a>
            </li>
            <li class="nav-item">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        placeholder="Enter site address" wire:model.defer="site_address">
                                        @error('site_address')
                ...
                <div class="pd-20">
                    <div class="row">
                        ...
                        <h5>Site logo</h5>
                             ...
                             <img wire:ignore src="{{ asset('images/site/'.$site_logo) }}" class="img-thumbnail" data-ijabo-default-img="{{ asset('images/site/'.$site_logo) }}" id="site_logo_image_preview">
                             </div>
                        ...
                        <div class="mb-2 mt-1" style="max-width: 100px;">
                            <img wire:ignore src="{{ asset('images/site/'.$site_favicon) }}" class="img-thumbnail" data-ijabo-default-img="{{ asset('images/site/'.$site_favicon) }}" id="site_favicon_image_preview">
                        </div>
